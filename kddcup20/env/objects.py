...
class Node(object):
    ...
    def __init__(self, index):
        ...
        self.drivers = {}  # a dictionary of driver objects contained in this
        # node
        self.order_num = 0
        ...
        self.layers_neighbors = []  # layer 1 indices: layers_neighbors[0] =
        # [[1,1], [0, 1], ...],
        # layer 2 indices layers_neighbors[1]
        self.layers_neighbors_id = []  # layer 1: layers_neighbors_id[0] = [
        # 2, 1,.]
    ...
    def remove_unfinished_order(self, city_time):
        ...
        for idx, o in enumerate(self.orders):
            ...
            # order completed
            if o.get_assigned_time() + o.get_duration() == city_time and \
                    o.get_assigned_time() != -1:
                un_finished_order_index.append(idx)
    ...
    def simple_order_assign(self, city_time, city):
        ...
        for idx in np.arange(num_assigned_order):
            ...
            for key, assigned_driver in self.drivers.iteritems():
                if assigned_driver.onservice is False and \
...
class Driver(object):
    ...
    def status_control_eachtime(self, city):
        ...
        if self.onservice is True:
            ...
            order_end_time = self.order.get_assigned_time() + \
                             self.order.get_duration()
...
class Order(object):
    ...
    def __init__(
        ...
        self._p = price
        self._waiting_time = wait_time  # a order can last for "wait_time" to
        # be taken
